<x-app-layout>
    <div class="h-screen w-screen flex flex-col overflow-hidden">
        <div class="relative z-10 w-full h-full flex flex-col overflow-hidden">
            {{-- Login Panel --}}
            <div class="shrink-0 relative flex flex-col items-center justify-center px-8 py-6 bg-white/95">

                {{-- Logo --}}
                <div class="relative z-10 flex flex-col items-center -mt-4">
                    <img src="{{ asset('images/BloomChain.png') }}" alt="Logo" class="h-28 w-auto object-contain">
                </div>

                {{-- Google button --}}
                <a href="{{ route('google.redirect') }}"
                    class="relative z-10 flex items-center justify-center gap-3 -mt-4 w-full px-3 py-2.5 bg-white border-[1.5px] border-green-100 text-green-900 rounded-full shadow-sm 
            ...
            <div class="flex-1 min-h-0 flex flex-col">
                ...
                {{-- Top banner --}}
                <div class="relative overflow-hidden shrink-0 py-5 px-5">
                    ...
                    <div class="relative z-10">
                        ...
                        <h1 class="text-lg font-light italic text-white leading-tight">
                            Where every plant tells a <span
                                class="not-italic font-semibold text-green-300">story.</span>
                        </h1>
                    </div>
                </div>

                {{-- Nursery list --}}
                <div class="flex-1 min-h-0 overflow-y-auto px-4 pt-4 pb-4 flex flex-col gap-5 bg-green-950 hide-scrollbar"
