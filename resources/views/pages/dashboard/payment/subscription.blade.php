...
<div class="min-h-screen bg-gray-50 text-gray-800">
    ...
    <div class="relative px-4 pt-14 pb-20 text-center overflow-hidden bg-white border-b border-gray-100">
        ...
        @if ($user->subscription_type === 'premium')
            <div
                class="inline-flex items-center gap-2 mb-5 px-4 py-2 rounded-full border border-yellow-400/50 bg-yellow-50">
        ...
        <h1 class="text-4xl md:text-6xl font-extrabold mb-4 leading-tight tracking-tight text-gray-900">
            Simple, honest
            ...
            <div class="flex flex-col items-center gap-8 w-full">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl w-full">
                    ...
                    <div class="relative rounded-2xl p-7 text-left flex flex-col transition-transform duration-300 hover:-translate-y-1 bg-white"
                        ...
                        <button
                            class="btn-outline w-full font-bold text-sm mt-4 py-3 px-5 rounded-full text-gray-700 mb-6">Your
                            current plan</button>
                            ...
                            @foreach (['General Features', 'Simple Dashboard', 'Add up to 5 plants'] as $f)
                                <li class="flex items-center gap-3 text-sm text-gray-600">
                                    <span class="check-icon">
                                        <svg width="10" height="10" viewBox="0 0 12 12" fill="none" stroke="#16714B"
                                            stroke-width="2.5">
                    ...
                    <div class="relative rounded-2xl p-7 text-left flex flex-col card-featured transition-transform duration-300 hover:-translate-y-1 bg-white overflow-hidden"
                        ...
                        <div class="flex items-start justify-between mb-1">
                            <p class="text-[11px] uppercase tracking-widest text-gray-400 font-semibold">BloomChain One
                            </p>
                            <span
                        ...
                        <div class="mb-5">
                            ...
                            <p class="text-gray-400 text-sm mt-[0.5px]" x-text="plans[duration].one.billed">Billed $29.88
                                every year</p>
        ...
        <div class="flex flex-wrap justify-center gap-6 mt-10">
            @foreach ([
                        ...
                        ['M12 5a3 3 0 1 1 3 3m-3-3a3 3 0 1 0-3 3m3-3v1|M9 8a3 3 0 1 0 3 3M9 8h1m5 0a3 3 0 1 1-3 3m3-3h-1m-2 3v-1|M12 10v12|M12 22c4.2 0 7-1.667 7-5-4.2 0-7 1.667-7 5Z|M12 22c-4.2 0-7-1.667-7-5 4.2 0 7 1.667 7 5Z', 'Unlimited plants'],
