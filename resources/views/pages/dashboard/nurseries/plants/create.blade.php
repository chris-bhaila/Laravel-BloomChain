            ...
            <form method="POST" action="{{ route('plants.store', $nursery->id) }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="category"
                        placeholder="Indoor / Outdoor / Flowering / etc."
                        class="w-full border rounded-lg px-4 py-2 focus:ring-2 focus:ring-green-500 focus:outline-none">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="sunlight_requirement"
                        placeholder="Full Sun / Partial Shade / Low Light"
                        class="w-full border rounded-lg px-4 py-2 focus:ring-2 focus:ring-green-500 focus:outline-none">
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="water_requirement"
                        placeholder="Daily / Weekly / Moderate"
                        class="w-full border rounded-lg px-4 py-2 focus:ring-2 focus:ring-green-500 focus:outline-none">
                </div>
