    ...
    <div x-show="!editing">
        ...
        <div class="px-4 py-5">
            ...
            <div class="mt-4 flex gap-3">
                <form action="{{ route('plants.destroy', $plant) }}" method="POST" class="w-1/2"
                    ...
                    <select name="category"
                        ...
                        @foreach ($options->get('category', collect()) as $option)
                            <option value="{{ $option->value }}"
                                {{ old('category', $plant->category) == $option->value ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <select name="location"
                        ...
                        @foreach ($options->get('location', collect()) as $option)
                            <option value="{{ $option->value }}"
                                {{ old('location', $plant->location) == $option->value ? 'selected' : '' }}>
                                {{ ucwords(str_replace('_', ' ', $option->value)) }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select name="best_season"
                        ...
                        @foreach ($options->get('best_season', collect()) as $option)
                            <option value="{{ $option->value }}"
                                {{ old('best_season', $plant->best_season) == $option->value ? 'selected' : '' }}>
                                {{ ucwords(str_replace('_', ' ', $option->value)) }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select name="sunlight_requirement"
                        ...
                        @foreach ($options->get('sunlight_requirement', collect()) as $option)
                            <option value="{{ $option->value }}"
                                {{ old('sunlight_requirement', $plant->sunlight_requirement) == $option->value ? 'selected' : '' }}>
                                {{ ucwords(str_replace('_', ' ', $option->value)) }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select name="water_requirement"
                        ...
                        @foreach ($options->get('water_requirement', collect()) as $option)
                            <option value="{{ $option->value }}"
                                {{ old('water_requirement', $plant->water_requirement) == $option->value ? 'selected' : '' }}>
                                {{ ucwords(str_replace('_', ' ', $option->value)) }}
                            </option>
                        @endforeach
                    </select>
