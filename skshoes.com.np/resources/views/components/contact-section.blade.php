<section id="contact" class="bg-white py-4 sm:py-6">
    <div class="w-full max-w-7xl px-4 mx-auto sm:px-8">
        <div class="text-center mb-4 sm:mb-6">
            <h2 class="text-2xl sm:text-3xl font-bold text-gray-800">Contact Us</h2>
        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                <!-- Twitter Card -->
                <div class="bg-white p-4 rounded-xl shadow-md border border-gray-100 transition-transform hover:scale-105">
